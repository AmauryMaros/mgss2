...
dtc <- dynamicTreeCut::cutreeDynamic(mgCST.hclust, distM = mgCST.dist, method="hybrid", minClusterSize = parameters$minClusterSize, deepSplit = parameters$deepsplit)
...
# mgCSTs$mgCST<-c(1:31)
mgCSTs$mgCST <- c(1:length(table(dtc)))
